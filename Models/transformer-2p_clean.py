...
def get_args():
    ...
    parser.add_argument('--filter_size', type=list, default= [10, 35, 70],
    ...
    parser.add_argument('--output_model_dir', type=str, default='./2p_CLEAN_runs', ## CHANGE DEFAULT
...
def load_data(root):
    data = torch.load("/home/yuhan/transformer_har/Data_clean_2p_w1000.pt")
...
def c_main():
    ...
    logfile_name = os.path.join(args.output_model_dir, "THAT_2p_clean_test20.txt")
    ...
    if logging:
        ...
        logfile.write(f"dropout_rate = {args.dropout_rate}, com_dim = {args.com_dim}, K = {args.K}\n")
...
def cross_validation():
    ...
    logfile = open("2p_clean_cross_validation_1.txt", "w")
